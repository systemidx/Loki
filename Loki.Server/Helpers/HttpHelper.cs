...
namespace Loki.Server.Helpers
{
    ...
    {
        public static string GetHeaderFromStream(Stream stream)
        {
        ...
        public static string ParseRoute(string header)
        {
        ...
        public static NameValueCollection ParseQueryStrings(string route)
        {
            if (!route.Contains("?"))
                return null;
